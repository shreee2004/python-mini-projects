...
if answer == "left":
    ...
    if answer == "back":
        ...
        if answer == "yes":
            print("You talk to the stranger and they give you what you wanted. You WIN!")

        elif answer == "no":
            print("You ignored the stranger and he shoots you because he thought you are an intruder and you lose.")
